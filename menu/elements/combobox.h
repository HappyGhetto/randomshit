...
void LOption::Paint()
{
	...
	if (Hovering)
		Draw->DrawRect(X, Y, w, h, Color(255, 255, 255, 5));

	Draw->DrawOutlinedRect(X, Y, w, h, LMenuFG);
	Draw->DrawString(textFont, X + 4, Y + 2, Color(255, 255, 255, 255), false, false, "%s", Text);
...
void LComboBox::Paint()
{
	...
	if (Hovering)
		Draw->DrawRect(X, Y, w - 20, h, Color(255, 255, 255, 5));
